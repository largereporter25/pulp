...
class Document(Base):
    ...
    mode: Mapped[str] = mapped_column(String, default="prose")  # screenplay|prose|poem|song|notes
    content: Mapped[str] = mapped_column(Text, default="")  # JSON string of ProseMirror doc
